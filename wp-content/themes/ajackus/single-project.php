...
get_header(); ?>
	...
	<section itemscope itemtype="http://schema.org/WebApplication" class="hero small accent parallax" style="background: url(<?php echo $post_thumbnail_url[0] ?>) no-repeat 50% 0px ; background-size: cover;" >
		...
		<div class="hero-content container col-xs-offset-3 col-xs-6" style="margin-top: 279.5px;">
			...
			<div class="domain-link">
				...
				<a itemprop="url" href="<?php echo types_render_field("project-url",$args)?>" target="_blank"><?php $sentence=types_render_field("project-url",$args);$sentence = preg_replace('(^https?://)', '', $sentence);echo $sentence?></a>
			...
			<?php 
				...
				$args = array("output"=>"raw");

				$company_name = types_render_field("company-name",$args);

				$company_logo = types_render_field("company-logo",array("output"=>"raw"));
				...
				if($company_name!='' ){
					...
					if($company_logo!=''){ ?>
						...
						<div class="collaboration">
							...
							<p>In collaboration with&nbsp;&nbsp;<a target="_blank" href="<?php echo types_render_field("company-url",array("output"=>"raw")); ?>"><img src="<?php echo $company_logo; ?>"></a></p>
					...
					<?php }else { ?>
						...
						<div class="collaboration">
							...
							<p>In collaboration with <a target="_blank" href="<?php echo types_render_field("company-url",array("output"=>"raw")); ?>"><?php echo $company_name; ?></a></p>
		...
		<div class="sub-hero container">
			...
			<?php $make =""; $i = 1; 
				...
				foreach((get_the_terms( $post->ID, 'project-category' )) as $makecat) {
			...
			<ul class="project-nav">
				...
				<?php if ($makecat->slug === 'print') { ?>

					<li class="prev-project clearfix nav-previous   col-xs-4"><div class="previous-center"><?php next_post_link('%link', 'Previous', FALSE, array(3,15) ,'project-category'); ?></div></li>

					<li class="all-project clearfix  col-xs-4"><div class="all-center"><a href="<?php get_home_url(); ?>/<?php echo $make;?>"><i class="icon keypad white"></i></a></div></li>

					<li class="next-project clearfix nav-next  col-xs-4"><?php previous_post_link('%link', 'Next', FALSE, array(3,15) ,'project-category' ); ?></li>

			    <?php } ?>

			    <?php if ($makecat->slug === 'web') { ?>

					<li class="prev-project clearfix nav-previous   col-xs-4"><div class="previous-center"><?php next_post_link('%link', 'Previous', FALSE, array(30,15) ,'project-category'); ?></div></li>

					<li class="all-project clearfix  col-xs-4"><div class="all-center"><a href="<?php get_home_url(); ?>/<?php echo $make;?>"><i class="icon keypad white"></i></a></div></li>

					<li class="next-project clearfix nav-next  col-xs-4"><?php previous_post_link('%link', 'Next', FALSE, array(30,15) ,'project-category' ); ?></li>

			    <?php } ?>

			    <?php if ($makecat->slug === 'mobile') { ?>

					<li class="prev-project clearfix nav-previous   col-xs-4"><div class="previous-center"><?php next_post_link('%link', 'Previous', FALSE, array(30,3) ,'project-category'); ?></div></li>

					<li class="all-project clearfix  col-xs-4"><div class="all-center"><a href="<?php get_home_url(); ?>/<?php echo $make;?>"><i class="icon keypad white"></i></a></div></li>

					<li class="next-project clearfix nav-next  col-xs-4"><?php previous_post_link('%link', 'Next', FALSE, array(30,3) ,'project-category' ); ?></li>
	...
	<?php $challengeValue = types_render_field("sp-challenge",$args); 

		if(!$challengeValue) { ?>



			<section class="center-mobile overview-block content container no-challenges">
				...
				<div class="row">
					...
					<div class="col-sm-12 center">
						...
						<div class="challenge-content">
							...
							<?php echo types_render_field("sp-challenge",$args); ?>
		...
		<div class="project-slider" style="width: 615%; position: relative; -webkit-transition: 0s; transition: 0s; -webkit-transform: translate3d(-1583px, 0px, 0px);">
					...
					<?php
						...
						<?php  
							...
							echo types_render_field("project-image", array("output"=>"normal"));
	...
	<?php 
		...
		foreach((get_the_terms( $post->ID, 'project-category' )) as $parentcat) {

			if ($parentcat->parent == 0) {

				$parent_cat .= $parentcat->name; 
		...
		<section class="container">
			...
			<div class="row">
				...
				<div class="milestone col-sm-4">
					...
					<span class="value" data-from="0" data-to="100" data-speed="1000" data-refresh-interval="100"><?php echo types_render_field("load-time", '');?></span>
				...
				<div class="milestone col-sm-4">
					...
					<span class="value" data-from="0" data-to="90" data-speed="1000" data-refresh-interval="100"><?php echo types_render_field("performance", '');?><span style="font-size: 24px;">/100</span></span>
		...
		<section class="container social">
			...
			<div class="row">
				...
				<div class="milestone col-sm-4">
					...
					<span class="value" data-from="0" data-to="5" data-speed="1000" data-refresh-interval="100">1200</span>
				...
				<div class="milestone col-sm-4">
					...
					<span class="value" data-from="0" data-to="100" data-speed="1000" data-refresh-interval="100">8</span>
				...
				<div class="milestone col-sm-4">
					...
					<span class="value" data-from="0" data-to="90" data-speed="1000" data-refresh-interval="100">10</span>
