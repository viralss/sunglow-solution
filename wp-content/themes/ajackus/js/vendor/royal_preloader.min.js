...
this._reQueue):this._reQueue())},_loadFinish:function(){this._use_css_animation?(this._overlay.addClass("complete"),$(document.body).removeClass("royal_loader")):setTimeout(function(){Royal_Preloader._overlay.addClass("complete");$(document.body).removeClass("royal_loader")},500);setTimeout(function(){Royal_Preloader._overlay.remove();Royal_Preloader._overlay=null},1E3)},config:function(a){"undefined"!==typeof a.mode&&(this._mode=a.mode);"undefined"!==typeof a.text&&(this._text=a.text);"undefined"!==
typeof a.timeout&&(this._timeout=parseInt(a.timeout));"undefined"!==typeof a.showPercentage&&(this._show_percentage=a.showPercentage?!0:!1);"undefined"!==typeof a.showInfo&&(this._show_info=a.showInfo?!0:!1);"undefined"!==typeof a.background&&(this._background=a.background);"undefined"!==typeof a.logo&&(this._logo=a.logo);"undefined"!==typeof a.opacity&&(this._opacity=a.opacity);"undefined"!==typeof a.images&&(this._images=a.images,Royal_Preloader._total=0,$.each(this._images,function(){Royal_Preloader._total++}))}};
...
preload([
    templateUrl + '/images/preloader.png',
    templateUrl + '/images/keyboard.jpg',
    templateUrl + '/images/logos/eden-new.png',
    templateUrl + '/images/logos/growhouse-new.png',
    templateUrl + '/images/logos/bha-new.png',
    templateUrl + '/images/logos/cm-new.png',
    templateUrl + '/images/logos/hrx-new.png',
    templateUrl + '/images/logos/solgari-new.png',
    templateUrl + '/images/logos/vogue-new.png',
    templateUrl + '/images/logos/weg-new.png',
...
Royal_Preloader.config({
            ...
            opacity:        1,
            background:     ['#fff'], 
            logo:            templateUrl +'/images/preloader.png'
});