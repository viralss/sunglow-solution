...
* Option for reCAPTCHA translation that based on default WordPress language that defined in the admin panel
* **NEW!** Filter and Action Hooks
* **NEW!** Added Support Right-to-Left Languages
